...
public class OkHttpUtils {
    ...
    public <T> void okGet(String url, final Class<T> cls, final IOkCallBack okCallBack) {
        ...
        call.enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                //执行在工作线程中，不能更新ui
                LogTool.LOG_D(OkHttpUtils.class, "-------->数据求情失败");
     ...
     * @param <T>
     */
    public <T> void okPost(String url,FormBody formBody, final Class<T> cls, final IOkCallBack iOkCallBack) {
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                LogTool.LOG_D(OkHttpUtils.class, "-------->数据求情成功"+s);
                final T t = GsonUtils.parseJson2Object(s, cls);
                mHandler.post(new Runnable() {
                    @Override
                    public void run() {
